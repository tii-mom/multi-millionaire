...
export default function ReceiptSubmission({
  ...
  return (
    <div className="financial-panel flex flex-col gap-3 rounded-[18px] p-4">
      {pendingDepositReceipt && (
        <div className="rounded-xl border border-[#d7b46a]/22 bg-[#d7b46a]/[0.07] p-3 font-mono text-[10px] leading-5 text-white/55">
      ...
      <button
        ...
        className="depth-button focus-ring rounded-xl border border-[#d7b46a]/25 bg-[#d7b46a]/10 py-3 text-[10px] font-bold uppercase tracking-widest text-[#d7b46a] hover:bg-[#d7b46a] hover:text-black disabled:cursor-not-allowed disabled:opacity-50"
      >
